...
class Event(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if self.event_start and self.event_start.tzinfo is None:
            self.event_start = make_aware(self.event_start, ist).astimezone(timezone('UTC'))
        if self.event_end and self.event_end.tzinfo is None:
            self.event_end = make_aware(self.event_end, ist).astimezone(timezone('UTC'))
